...
pub struct Theme {
    ...
    pub hl_token_macro_keyword: CellTheme,
    pub hl_token_string: CellTheme,
    pub hl_token_fmt_string: CellTheme,
...
impl Default for Theme {
    fn default() -> Self {
        ...
        Self {
            ...
            hl_token_macro_keyword: fg(Color::AnsiValue(115)),
            hl_token_string: fg(Color::AnsiValue(179)),
            hl_token_fmt_string: fg(Color::AnsiValue(173)),
...
impl Theme {
    pub fn token_theme(&self, token: TokenKind) -> CellTheme {
        match token {
            ...
            TokenKind::MacroKeyword => self.hl_token_macro_keyword,
            TokenKind::String => self.hl_token_string,
            TokenKind::FmtString => self.hl_token_fmt_string,
